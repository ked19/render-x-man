...
Fl_Value_Slider *pLocalL_valScl=(Fl_Value_Slider *)0;
...
Fl_Check_Button *pKey_bttn=(Fl_Check_Button *)0;

Fl_Value_Slider *pKey_valScl=(Fl_Value_Slider *)0;

Fl_Check_Button *pFeature_bttn=(Fl_Check_Button *)0;

Fl_Value_Slider *pFeature_valScl=(Fl_Value_Slider *)0;
...
Fl_Double_Window* make_window() {
  { pMain_win = new Fl_Double_Window(1390, 769, "renderXman");
    ...
    { pDisAtt_valScl = new Fl_Value_Slider(1208, 35, 180, 25, "distance attenuation");
      ...
      pDisAtt_valScl->align(Fl_Align(FL_ALIGN_TOP));
    ...
    { pSmpNum_valScl = new Fl_Value_Slider(1208, 78, 180, 25, "sample number");
      ...
      pSmpNum_valScl->align(Fl_Align(FL_ALIGN_TOP));
    ...
    { pBriScl_valScl = new Fl_Value_Slider(1208, 121, 180, 25, "bright scale");
      ...
      pBriScl_valScl->align(Fl_Align(FL_ALIGN_TOP));
    ...
    { pXtereo_group = new Fl_Group(1025, 329, 170, 270);
      ...
      { pDivion_valScl = new Fl_Value_Slider(1030, 388, 160, 20, "visible layer");
        pDivion_valScl->type(5);
        pDivion_valScl->minimum(0.01);
        pDivion_valScl->maximum(0.5);
        pDivion_valScl->value(0.02);
        pDivion_valScl->textsize(14);
        pDivion_valScl->callback((Fl_Callback*)ChangeDivThrd);
        pDivion_valScl->align(Fl_Align(FL_ALIGN_TOP));
      } // Fl_Value_Slider* pDivion_valScl
      { Fl_Group* o = new Fl_Group(1030, 418, 160, 51);
        o->box(FL_DOWN_BOX);
        { pKey_bttn = new Fl_Check_Button(1032, 418, 88, 25, "key value");
          pKey_bttn->down_box(FL_DOWN_BOX);
          pKey_bttn->value(1);
          pKey_bttn->callback((Fl_Callback*)SetKey);
        } // Fl_Check_Button* pKey_bttn
        { pKey_valScl = new Fl_Value_Slider(1034, 444, 151, 20, "gamma power");
          pKey_valScl->type(5);
          pKey_valScl->labeltype(FL_NO_LABEL);
          pKey_valScl->minimum(0.1);
          pKey_valScl->maximum(0.9);
          pKey_valScl->step(0.05);
          pKey_valScl->value(0.25);
          pKey_valScl->textsize(14);
          pKey_valScl->callback((Fl_Callback*)ChangeKey);
          pKey_valScl->align(Fl_Align(FL_ALIGN_TOP));
      ...
      { Fl_Group* o = new Fl_Group(1030, 478, 165, 52);
        ...
        { pFeature_bttn = new Fl_Check_Button(1033, 483, 117, 15, "feature");
          pFeature_bttn->down_box(FL_DOWN_BOX);
          pFeature_bttn->value(1);
          pFeature_bttn->callback((Fl_Callback*)SetFeature);
        } // Fl_Check_Button* pFeature_bttn
        { pFeature_valScl = new Fl_Value_Slider(1034, 505, 156, 20, "ratio");
          pFeature_valScl->type(5);
          pFeature_valScl->labeltype(FL_NO_LABEL);
          pFeature_valScl->minimum(1);
          pFeature_valScl->maximum(20);
          pFeature_valScl->step(1);
          pFeature_valScl->value(10);
          pFeature_valScl->textsize(14);
          pFeature_valScl->callback((Fl_Callback*)ChangeFeaScl);
          pFeature_valScl->align(Fl_Align(FL_ALIGN_TOP));
        } // Fl_Value_Slider* pFeature_valScl
        o->end();
      } // Fl_Group* o
      { Fl_Group* o = new Fl_Group(1030, 540, 165, 27);
        o->box(FL_DOWN_BOX);
        o->labeltype(FL_NO_LABEL);
        { pDim_bttn = new Fl_Check_Button(1033, 545, 117, 15, "dimming");
      ...
      { pStFusion_bttn = new Fl_Button(1030, 573, 160, 20, "Xtereo");
